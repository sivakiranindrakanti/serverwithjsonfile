...
app.get('/Storybook/page/:id', (req,res) =>{
   ...
   if(Number == 1){
     ...
     res.send('<html lang="te" dir="ltr"><head><meta charset="utf-8">  <style> *{ margin: 0px; padding: 0px;}.n1{ position: relative;top:30px;left: 300px;}.n2{position: relative;left:480px;top: 80px;}.n3 {position: relative;left: 300px;top:140px;}nav{position: relative;top:220px;left:1000px;width:120px;height: 60px;background-color: aqua;}nav ul{position: relative;top:20px;background-color: transparent;left:40px;}.n4{position: relative;top: 170px;left: 120px;width:120px;height: 60px;background-color: aqua;}.n4 ul{position: relative;top:20px;background-color: transparent;left:30px;}</style></head><body><center><h2>'+config.title_en+'</h2></center><div class="n2"><img src ='+'/'+config.cover_image+' width ="340" height="250"></div><div class="n3"><h3>'+ config.title+'</h3></div><nav><ul><a href="'+(Number - 1 + 2)+'"color="transparent">Next</a></ul></nav></body></html>')
   }
   else{
    var pageDetails = getmypage(Number);
    
    res.send('<html lang="te" dir="ltr"><head><meta charset="utf-8">  <style> *{ margin: 0px; padding: 0px;}.n1{ position: relative;top:30px;left: 300px;}.n2{position: relative;left:480px;top: 80px;}.n3 {position: relative;left: 300px;top:140px;}nav{position: relative;top:220px;left:1000px;width:120px;height: 60px;background-color: aqua;}nav ul{position: relative;top:20px;background-color: transparent;left:40px;}.n4{position: relative;top: 170px;left: 120px;width:120px;height: 60px;background-color: aqua;}.n4 ul{position: relative;top:20px;background-color: transparent;left:30px;}</style></head><body><center><h2>'+pageDetails.english+'</h2></center><div class="n2"><img src ='+'/'+pageDetails.image+' width ="340" height="250"></div><div class="n3"><h3>'+ pageDetails.telugu+'</h3></div><nav><ul><a href="'+(Number - 1 + 2)+'"color="transparent">Next</a></ul></nav><div class="n4"><ul><a href="'+(Number - 1)+'">Previous</a></ul></div></body></html>');
   }
});
